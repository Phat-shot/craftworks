...
import AropsLobbyPanel from '../components/AropsLobbyPanel';
...
export default function LobbyRoom() {
  ...
  return (
    <div className="lobby-room">
      ...
      {/* AR Ops: playfield + roles + timers (replaces race selection) */}
      {lobby.game_mode === 'ar_ops' && (
        <AropsLobbyPanel
          lobbyId={id}
          isHost={isHost}
          ...
          initialSettings={lobby.workshop_map_config?.ar_settings}
        />
      )}
