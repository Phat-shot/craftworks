  ...
  return (
    <div style={{ padding: 24, maxWidth: 640, margin: '0 auto' }}>
      ...
      <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:12, marginBottom:28 }}>
        <div onClick={startSolo} style={{ background:'linear-gradient(135deg,#1a2a0a,#0e1806)', border:'2px solid #3a6020', borderRadius:12, padding:20, cursor:'pointer', display:'flex', flexDirection:'column', gap:8 }}
        ...
        <div onClick={() => navigate('/lobby')} style={{ background:'linear-gradient(135deg,#1a0e2a,#0e0816)', border:'2px solid #602080', borderRadius:12, padding:20, cursor:'pointer', display:'flex', flexDirection:'column', gap:8 }}
