'use strict';
// engine/common.js — shared constants, utilities, TD core
// ═══════════════════════════════════════════════════════
...
module.exports = {
  // Constants
  COLS, ROWS, ENTRY_COL, TILE, MAIN_HP, VS_COLS, VS_ROWS, UNIT_SPEED,
  // Enemy config
  EBASE, EBASE_HP,
  // Wave config
  getWaveConfig, getWaveType, buildWaveConfig,
  // Pathfinding
  findPath, canPlaceAt,
  // Game creation / tick / snapshot (TD)
  createGame, tick, getSnapshot,
  // Utilities used by other modes
  endGame, dealDmg, applyPoison, applySlow, applyFire,
  spawnHit, spawnDeath, spawnExp, rerouteEnemies,
  startWave, checkWaveEnd,
  // Calc
