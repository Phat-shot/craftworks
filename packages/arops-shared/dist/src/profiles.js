...
exports.GAME_MODE_PROFILES = {
    ...
    battle_royale: {
        id: 'battle_royale',
        name: 'Battle Royale',
        shortDescription: 'Jeder gegen jeden, keine Teams. Ein Treffer scheidet endgültig aus — letzter ' +
            'Überlebender gewinnt.',
        longDescription: 'Kein Team, keine Rolle, keine Basis: jeder Spieler ist Gegner jedes anderen. ' +
