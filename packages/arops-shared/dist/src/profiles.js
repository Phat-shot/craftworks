...
exports.GAME_MODE_PROFILES = {
    hide_and_seek: {
        ...
        submodes: [
            { id: 'ffa', name: 'Jeder gegen jeden',
                shortDescription: 'Kein Team, keine Rolle — jeder ist Gegner von jedem. Ein Treffer scheidet endgültig ' +
    ...
    domination: {
        ...
        submodes: [
            { id: 'ffa', name: 'Jeder gegen jeden',
                shortDescription: 'Kein Team — jede Zone wird individuell erobert (zählt nur, solange genau ein ' +
    ...
    ctf: {
        ...
        submodes: [
            { id: 'ffa', name: 'Jeder gegen jeden',
                shortDescription: 'Statt zwei Teams hat JEDER Spieler eine eigene Basis und eigene Flagge (N ' +
    ...
    seek_destroy: {
        id: 'seek_destroy',
        name: 'Zerstören',
        shortDescription: 'Ein rotierendes Ziel ist aktiv; wird es eingenommen, ist es zerstört und ' +
            'das nächste aktiviert. Symmetrisch (beide Teams) oder mit Entschärfen (asymmetrisch).',
        longDescription: 'Von den host-platzierten oder zufällig generierten Zielen ist immer genau ' +
        ...
        submodes: [
            { id: 'ffa', name: 'Jeder gegen jeden',
                shortDescription: 'Kein Team — jeder Spieler erobert das aktive Ziel für sich allein. Nur mit der ' +
    ...
    deathmatch: {
        id: 'deathmatch',
        name: 'Deathmatch',
        shortDescription: 'Zwei Teams kämpfen ohne weiteres Ziel gegeneinander. Treffer frieren ein oder ' +
            'kosten ein Leben (host-konfigurierbar) — bei 0 Leben scheidet man aus.',
        longDescription: 'Wie Domination/CTF beginnt Deathmatch mit einer Basis-Setup-Phase (Kapitän ' +
        ...
        submodes: [
            { id: 'ffa', name: 'Jeder gegen jeden',
                shortDescription: 'Kein Team — jeder Spieler platziert die eigene Basis/Respawnpunkt statt eines ' +
...
exports.GLOSSARY = [
    ...
    { term: 'Target', definition: 'Das jeweilige Ziel eines Modus — in Hide & Seek die Hider selbst, in Zerstören der aktive Zielort, ' +
            'in The Ship die geheim zugewiesene Person, die man jagen muss.' },
    { term: 'Captain', definition: 'Der erste einem Team zugeloste Spieler — in Capture the Flag und Deathmatch verantwortlich für die ' +
    ...
    { term: 'Jeder gegen jeden (FFA)', definition: 'Team-Variante ohne feste Seiten: statt zwei Teams ist jeder Spieler für sich allein und Gegner von ' +
